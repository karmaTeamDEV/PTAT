...
//echo "<pre>";print_r($current_color);
   ...
   function get_level_data_for_spider_post(){
    ...
    function select_all_outcomeList_by_level_id_post(){
              ...
              $backlog = $this->Dashboard_model->select_all_outcomeList_by_level_id($company_id,$level_id,$biz_outcome_id);
              ...
              {
                  $getEmpSalary = array('record' => '0');
                  $this->response($getEmpSalary, 200);
              }
   } 
