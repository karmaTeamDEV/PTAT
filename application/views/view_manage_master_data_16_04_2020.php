...
<body class="nav-md">
    ...
    <div class="main_container">
          ...
          <div class="x_panel" style="padding-bottom:0px;padding-top:0px;">
            ...
            <div class="tab-content">
             ...
             <div class="col-md-4 col-sm-4 input_field_sections" style="float: right;text-align: right;">
              ...
              <button type="button" class="btn btn-primary" onclick="add_update_user();" style="margin-right: 0px;">Save</button> 
            </div> 
      ...
      <div id="menu1" class="tab-pane fade">
       ...
       <div class="col-md-4 col-sm-4 input_field_sections" style="float: right;text-align: right;">
        ...
        <button type="button" class="btn btn-primary" onclick="add_update_biz_impact();" style="margin-right: 0px;">Save</button>
      </div> 
  ...
  <div class="col-md-4 col-sm-4 input_field_sections" style="float: right;text-align: right;">
    ...
    <button type="button" class="btn btn-primary" onclick="add_update_company_level();" style="margin-right: 0px;">Save</button>
  </div> 
...
<div class="col-md-4 col-sm-4 input_field_sections" style="float: right;text-align: right;">
  ...
  <button type="button" class="btn btn-primary" onclick="add_update_outcome();" style="margin-right: 0px;">Save</button>
</div> 
...
$(document).ready(function() {
 ...
 function add_update_user(){
  ...
  .success(function (data, textStatus, xhr){ 
      ...
      $('#user_error_msg').show();
      setTimeout(function() { $("#user_error_msg").slideUp(1000); }, 2500);
      $('#first_name').val('');
      $('#last_name').val('');
      $('#email').val('');    
      $('#password').val('');
...
function add_update_biz_impact(){
  ...
  .success(function (data, textStatus, xhr){  
      ...
      $('#biz_error_msg').show();
      setTimeout(function() { $("#biz_error_msg").slideUp(1000); }, 2500);
      $('#business_impact').val('');
      $('#measure').val('');
      $('#biz_ordering').val('');    
      $('#biz_description').val('');           
...
function add_update_company_level(){
    ...
    .success(function (data, textStatus, xhr){   
          ...
          setTimeout(function() { $("#level_error_msg").slideUp(1000); }, 2500);
          $('#level').val('');            
          $('#level_ordering').val('');    
...
function add_update_outcome(){
      ...
      .success(function (data, textStatus, xhr){  
          ...
          setTimeout(function() { $("#outcome_error_msg").slideUp(1000); }, 2500);
