...
//console.log(business_impact_array);
   ...
   $.ajax({
           type: "POST",
           url: '<?php echo base_url();?>index.php/ptat_api/dashboard_api/get_dashboard_report/',
              ...
              var mydate = new Date(data[i]['added_date']);
                var curr_date = mydate.getDate();
                   ...
                   // var second = mydate.getSeconds();
                    ...
                    var format_date=curr_month +"/"+ curr_date +"/"+curr_year+' '+hours+':'+minute+' '+ampm;
